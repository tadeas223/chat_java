...
public class SQLConnection {
    private final String DB_FILE = "database.db";
    private final Server server;
    private Connection connection;


    public SQLConnection(Server server) throws SQLException, IOException {
        this.server = server;
        if (!isInitialized()){
            init();
        }
    ...
    private void connect() throws SQLException {
        connection = DriverManager.getConnection("jdbc:sqlite:" + server.getFileCreator().getAbsolutePath(DB_FILE));
    }
